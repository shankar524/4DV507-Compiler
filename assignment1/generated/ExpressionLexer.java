...
public class ExpressionLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"INT", "FLOAT", "BOOL", "CHAR", "STRING", "VOID", "PRINT_FUNCTION", "COMMENT", 
			"WS", "INTEGER_LITERAL", "FLOAT_LITERAL", "BOOL_LITERAL", "CHAR_LITERAL", 
			"STRING_LITERAL", "ID", "Digits", "Letter", "LetterOrDigit", "ESC"
		};
	}
